...
@section('title', trans('videos::global.name'))
...
<div ng-app="typicms" ng-cloak ng-controller="ListController">
    ...
    <h1>
        <span>@{{ models.length }} @choice('videos::global.videos', 2)</span>
    </h1>
    ...
    <div class="table-responsive">
        ...
        <table st-persist="videosTable" st-table="displayedModels" st-safe-src="models" st-order st-filter class="table table-condensed table-main">
            <thead>
                <tr>
                    <th class="delete"></th>
                    <th class="edit"></th>
            ...
            <tbody>
                <tr ng-repeat="model in displayedModels">
                    ...
                    <td>
                        @include('core::admin._button-edit', ['module' => 'videos'])
                    </td>
